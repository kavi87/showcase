...
define([
    ...
    var config = module && module.config() || {},
        seedStoreCategoryManagement = angular.module('SeedStoreCategoryManagement', ['ui.bootstrap']);
    seedStoreCategoryManagement.value('storedCategory', {});
    seedStoreCategoryManagement.value('editedCategory', {});

    seedStoreCategoryManagement.factory('SeedStoreCategoryService', ['$resource', function ($resource) {
    ...
    seedStoreCategoryManagement.controller('ModalCategoryController', ['$scope', '$modalInstance', 'category', 'modalTitle', function ($scope, $modalInstance, category, modalTitle) {
    ...
    seedStoreCategoryManagement.controller('SeedStoreCategoryManagementController', ['$scope', '$modal', '$timeout', 'SeedStoreCategoryService', '$location', 'NotificationService', 'SeedStoreProductService', function ($scope, $modal, $timeout, categoryService, notificationService) {
    ...
    return {
        angularModules: ['SeedStoreCategoryManagement']
    };
});
