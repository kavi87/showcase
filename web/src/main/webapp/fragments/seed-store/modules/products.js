...
define([
    ...
    '{seed-store-admin}/modules/categories',
    '{w20-ui}/modules/ui'
], function (require, module, angular) {
    'use strict';

    var seedStoreProductManagement = angular.module('SeedStoreProductManagement', ['ngSanitize', 'SeedStoreCategoryManagement', 'ui.bootstrap']),
        config = module && module.config() || {};

    seedStoreProductManagement.factory('SeedStoreProductService', ['$resource', function ($resource) {
    ...
    seedStoreProductManagement.controller('SeedStoreProductsManagementController', ['$scope', '$modal', 'SeedStoreProductService', 'NotificationService', 'SeedStoreCategoryService', function ($scope, $modal, productService, notificationService, categoryService) {
    ...
    return {
        angularModules: ['SeedStoreProductManagement']
    };
});
