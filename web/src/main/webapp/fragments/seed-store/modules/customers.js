...
define([
    ...
    var seedStoreCustomerManagement = angular.module('SeedStoreCustomerManagement', []),
        config = module && module.config() || {};

    seedStoreCustomerManagement.factory('SeedStoreCustomerService', ['$resource', function ($resource) {
    ...
    seedStoreCustomerManagement.controller('SeedStoreCustomersManagementController', ['$scope', '$modal', 'SeedStoreCustomerService', 'NotificationService', function ($scope, $modal, customerService, notificationService) {
    ...
    return {
        angularModules: ['SeedStoreCustomerManagement']
    };
});
